...
Decrypter.decryptImg = function(url, bitmap) {
    ...
    requestFile.onload = function () {
        if(this.status < Decrypter._xhrOk) {
            ...
            bitmap._image.addEventListener('load', this._loadListener = Bitmap.prototype._onLoad.bind(this));
            bitmap._image.addEventListener('error', this._errorListener = Bitmap.prototype._onError.bind(this));
        }
    };
};
